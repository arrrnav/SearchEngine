  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
        ...
        <div className="space-y-8">
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="text-xs text-gray-600 dark:text-gray-400 text-center max-w-xl">
              Tip: Boolean Search supported too! Use "AND" for exact matches (e.g., "machine AND learning")
            </div>
      ...
      <footer className="mt-12 py-6 border-t border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-4 text-center text-sm text-gray-500 dark:text-gray-400 flex items-center justify-center gap-3">
          <span>Zotics Engine — Built by Arnav</span>
          <a
